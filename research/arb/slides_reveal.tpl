...
<script>
// Because there is an <iframe> in the slides, loading that blocks
// window.onload, so we don't use the timeout hack that's in the official
// IPython templates, but just create the script directly.
